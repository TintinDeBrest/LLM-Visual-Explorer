...
def build_semantic_core(embeddings, concepts):
    """
    ...
    3. On calcule une force sémantique relative par rapport à la
       similarité de la paire initiale.
    ...
    # Force maximale = 1
    semantic_strength = {concepts[i]: 1.0, concepts[j]: 1.0}
    ...
    while len(core_indices) < n:
        ...
        # Force relative par rapport à la paire initiale
